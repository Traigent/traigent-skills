...
GAP_EXCEPTIONS: dict[GapKey, str] = {
    ...
    # ---- no hashed entries at all --------------------------------------
    ("traigent-setup-audit", "NO_HASHED_ENTRIES", "be9895ccc3835b1f"): (
        "no entry in this file carries doc_before_hash/doc_after_hash — the "
        "whole document is unproven from genesis onward, not just its most "
        "recent edit; pre-existing, out of scope for #196"
    ),
}
