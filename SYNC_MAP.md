...
| `traigent-analyze-guidance` | `traigent/api/decorators.py`, `traigent/core/optimized_function.py`, `traigent/api/types.py`, `traigent/utils/insights.py`, `traigent/utils/importance.py`, `traigent/analytics/example_insights.py`, `traigent/analytics/planner.py`, `traigent/cli/guidance_command.py` |
