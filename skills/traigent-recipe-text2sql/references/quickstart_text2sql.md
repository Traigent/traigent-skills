...
def main() -> int:
    ...
    if args.mock:
        ...
        offline, algorithm = True, "grid"          # named smart algorithms never run locally/offline
    else:
        ...
        # "auto" for the zero-config connected path to real cloud Optuna TPE.
        # On SDK >= 0.20.1, "bayesian"/"tpe"/"optuna" also bind server-side in
        # connected runs (Traigent/Traigent#1752/#1758); they never run locally.
